  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-full font-medium text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 before:absolute before:inset-0 before:rounded-full before:transition before:duration-300 active:duration-75 active:before:scale-95 disabled:pointer-events-none disabled:opacity-50 gap-2.5",
  {
    variants: {
      variant: {
        ...
        custom_submit_secondary:
          "relative before:bg-primary-dark-green text-primary-soft-green before:hover:bg-primary-dark-green/90",
        custom_submit_tertiary:
          "relative before:bg-primary-high-green text-primary-soft-green before:hover:bg-primary-high-green/90",
        custom_submit_quaternary:
          "relative before:bg-primary-medium-green text-primary-dark-green before:hover:bg-primary-medium-green/90 dark:before:bg-primary-dark-green dark:text-primary-soft-green dark:before:hover:bg-primary-dark-green/90",
      },
      size: {
